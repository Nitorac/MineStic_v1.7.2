package nitorac.minestic.dimension.fx;
...
public class PlasticSkyRenderer extends IRenderHandler
	{
	private int starGLCallList;
	private int glSkyList;
	private int glSkyList2;
	public PlasticSkyRenderer()
	{
...
public void render(float partialTicks, WorldClient world, Minecraft mc) 
{
	  ...
	  f10 = 70.0F; // Size of sun from center
	  mc.renderEngine.bindTexture(new ResourceLocation("minestic","textures/environment/plastic_sun.png")); // Sun texture + texture path
	  ...
	  f10 = 50.0F; // Size of moon from center
	  mc.renderEngine.bindTexture(new ResourceLocation("minestic","textures/environment/plasticmoon_phases.png")); // Moon texture + texture path
