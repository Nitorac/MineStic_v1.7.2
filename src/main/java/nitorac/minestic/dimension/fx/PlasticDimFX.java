...
public class PlasticDimFX extends EntityFX
{
    ...
    public PlasticDimFX(World var1, double var2, double var4, double var6, double var8, double var10, double var12)
    {
        ...
        this.particleGreen *= 14.3F;
        this.particleBlue *= 2.2F;
        this.particleMaxAge = (int)(Math.random() * 10.0D) + 40;
        this.noClip = true;
        this.setParticleTextureIndex((int)(Math.random() * 10.0D));
    }
