...
public class BlockGrassPlastic extends Block implements IGrowable
{
    ...
    @SideOnly(Side.CLIENT)
    public IIcon field_149994_N;
    private static final String __OBFID = "CL_00000251";

    public BlockGrassPlastic()
    {
    ...
    {
        return p_149691_1_ == 1 ? this.field_149991_b : (p_149691_1_ == 0 ? MineStic.plasticDirt.getBlockTextureFromSide(p_149691_1_) : this.blockIcon);
    }
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        if (!p_149674_1_.isRemote)
        {
            ...
            {
                p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, MineStic.plasticDirt);
            }
            else if (p_149674_1_.getBlockLightValue(p_149674_2_, p_149674_3_ + 1, p_149674_4_) >= 9)
            {
                for (int l = 0; l < 4; ++l)
                {
                    ...
                    if (p_149674_1_.getBlock(i1, j1, k1) == MineStic.plasticDirt && p_149674_1_.getBlockMetadata(i1, j1, k1) == 0 && p_149674_1_.getBlockLightValue(i1, j1 + 1, k1) >= 4 && p_149674_1_.getBlockLightOpacity(i1, j1 + 1, k1) <= 2)
                    {
                        p_149674_1_.setBlock(i1, j1, k1, MineStic.plasticGrass);
                    }
                }
            }
        }
    ...
    {
        return MineStic.plasticDirt.getItemDropped(0, p_149650_2_, p_149650_3_);
    }
    ...
    public IIcon getIcon(IBlockAccess p_149673_1_, int p_149673_2_, int p_149673_3_, int p_149673_4_, int p_149673_5_)
    {
        ...
        {
            return MineStic.plasticDirt.getBlockTextureFromSide(p_149673_5_);
        }
        else
        {
        ...
        while (l < 128)
        {
            ...
            while (true)
            {
                if (l1 < l / 16)
                {
                    ...
                    if (p_149853_1_.getBlock(i1, j1 - 1, k1) == MineStic.plasticGrass && !p_149853_1_.getBlock(i1, j1, k1).isNormalCube())
                    {
                        ++l1;
                        continue;
                    }
