...
public class PlasticFire extends BlockFire {
    ...
    {
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.planks), 70, 20);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.double_wooden_slab), 70, 20);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.wooden_slab), 70, 20);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.fence), 70, 20);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.oak_stairs), 70, 20);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.birch_stairs), 70, 20);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.spruce_stairs), 70, 20);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.jungle_stairs), 70, 20);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.log), 70, 5);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.log2), 70, 5);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.leaves), 70, 60);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.leaves2), 70, 60);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.bookshelf), 70, 20);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.tnt), 70, 100);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.tallgrass), 70, 100);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.double_plant), 70, 100);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.yellow_flower), 70, 100);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.red_flower), 70, 100);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.wool), 70, 60);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.vine), 70, 100);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.coal_block), 70, 5);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.hay_block), 70, 20);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.carpet), 70, 20);
        Blocks.fire.func_149842_a(getIdFromBlock(Blocks.grass), 0, 20);
    }
    ...
    {
        if (world.provider.dimensionId < 0 || !PlasticPortal.func_150000_e(world, p_149726_2_, p_149726_3_, p_149726_4_))
        {
    ...
    {
        this.field_149850_M = new IIcon[] {p_149651_1_.registerIcon("minestic:black_fire_layer_0"), p_149651_1_.registerIcon("minestic:black_fire_layer_1")};
    }
    ...
    {
        private int encouragement = 60;
        private int flammibility = 300;
    }
