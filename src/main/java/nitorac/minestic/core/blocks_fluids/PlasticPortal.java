...
import nitorac.minestic.dimension.PlasticTeleporter;
import nitorac.minestic.dimension.fx.PlasticDimFX;
import cpw.mods.fml.client.FMLClientHandler;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class PlasticPortal extends BlockBreakable
{
	public static final int[][] field_150001_a = new int[][] {new int[0], {3, 1}, {2, 0}};

	public PlasticPortal()
	{
		super("minestic:plastic_portal", Material.portal, false);
    ...
    public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
    {
        if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
        {
            ...
            else if (thePlayer.dimension != MineStic.PlasticDimID)
            {
                thePlayer.timeUntilPortal = 10;
                thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, MineStic.PlasticDimID, new PlasticTeleporter(thePlayer.mcServer.worldServerForDimension(MineStic.PlasticDimID)));
            }
            else {
                thePlayer.timeUntilPortal = 10;
                thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new PlasticTeleporter(thePlayer.mcServer.worldServerForDimension(0)));
            }
        }
    }
	...
	{
		PlasticPortal.Size size = new PlasticPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 1);
		PlasticPortal.Size size1 = new PlasticPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 2);
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
	{
		...
		PlasticPortal.Size size = new PlasticPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 1);
		PlasticPortal.Size size1 = new PlasticPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 2);
	...
	public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
	{
		...
		for (int l = 0; l < 4; ++l)
		{
			...
			PlasticDimFX var20 = new PlasticDimFX(p_149734_1_, d0, d1, d2, d3, d4, d5);
	...
	public static class Size
	{
		...
		public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
		{
			...
			this.field_150863_d = PlasticPortal.field_150001_a[p_i45415_5_][0];
			this.field_150866_c = PlasticPortal.field_150001_a[p_i45415_5_][1];
		...
		protected int func_150853_a(int p_150853_1_, int p_150853_2_, int p_150853_3_, int p_150853_4_)
		{
			...
			for (i1 = 0; i1 < 22; ++i1)
			{
				...
				if (block1 != MineStic.CompPlastic)
				{
					break;
				}
			}
			...
			block = this.field_150867_a.getBlock(p_150853_1_ + j1 * i1, p_150853_2_, p_150853_3_ + k1 * i1);
			return block == MineStic.CompPlastic ? i1 : 0;
		}
		...
		protected int func_150858_a()
		{
			...
			label56:
				...
				for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
				{
					...
					{
						k = this.field_150861_f.posX + j * Direction.offsetX[PlasticPortal.field_150001_a[this.field_150865_b][1]];
						l = this.field_150861_f.posZ + j * Direction.offsetZ[PlasticPortal.field_150001_a[this.field_150865_b][1]];
						...
						if (block == MineStic.plasticPortal)
						{
							++this.field_150864_e;
						}
						...
						if (j == 0)
						{
							block = this.field_150867_a.getBlock(k + Direction.offsetX[PlasticPortal.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[PlasticPortal.field_150001_a[this.field_150865_b][0]]);

							if (block != MineStic.CompPlastic)
							{
								break label56;
							}
						}
						...
						{
							block = this.field_150867_a.getBlock(k + Direction.offsetX[PlasticPortal.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[PlasticPortal.field_150001_a[this.field_150865_b][1]]);
			...
			{
				j = this.field_150861_f.posX + i * Direction.offsetX[PlasticPortal.field_150001_a[this.field_150865_b][1]];
				k = this.field_150861_f.posY + this.field_150862_g;
				l = this.field_150861_f.posZ + i * Direction.offsetZ[PlasticPortal.field_150001_a[this.field_150865_b][1]];

				if (this.field_150867_a.getBlock(j, k, l) != MineStic.CompPlastic)
				{
		...
		{
			return block.getMaterial() == Material.air || block == MineStic.plasticFire || block == MineStic.plasticPortal;
		}
		...
		public void func_150859_c()
		{
			for (int i = 0; i < this.field_150868_h; ++i)
			{
				...
				for (int l = 0; l < this.field_150862_g; ++l)
				{
					...
					this.field_150867_a.setBlock(j, i1, k, MineStic.plasticPortal, this.field_150865_b, 2);
				}
			}
		}
	}
