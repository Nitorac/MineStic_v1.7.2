...
public class ItemBlockPlasticSlab extends ItemBlock
{
	private final boolean isFullBlock;
	private final Block theHalfSlab;
	private final Block doubleSlab;

	public ItemBlockPlasticSlab(Block block)
	{
		super(block);
		this.theHalfSlab = MineStic.MineSlab;
		this.doubleSlab = MineStic.DoubleMineSlab;
		if(block == MineStic.DoubleMineSlab)
		{
	...
	{
		return ((PlasticSlabs)theHalfSlab).func_150002_b(stack.getItemDamage());
	}
