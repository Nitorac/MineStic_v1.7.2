package nitorac.minestic.core.tileentity;
...
public class TileEntityPlasticExtractor extends TileEntity implements IInventory
{
    /**
    ...
    public TileEntityPlasticExtractor()
    {
